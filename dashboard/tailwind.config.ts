  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        tile: '0 8px 24px -6px rgba(0, 0, 0, 0.35), inset 0 1px 0 0 rgba(255, 255, 255, 0.08)',
        tileHover: '0 12px 36px -4px rgba(0, 0, 0, 0.55), inset 0 1px 0 0 rgba(255, 255, 255, 0.12)',
        tileSelected: '0 14px 36px -4px rgba(14, 155, 124, 0.25), inset 0 1px 0 0 rgba(255, 255, 255, 0.15)',
        popup: '0 24px 60px -12px rgba(0, 0, 0, 0.75), 0 0 30px 2px rgba(14, 155, 124, 0.2)',
      },
      borderRadius: {
        glass: '18px',
      },
